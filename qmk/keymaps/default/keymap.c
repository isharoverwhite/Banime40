...
/*
 * banime40 — Default Keymap (ATmega32U4 / QMK)
 * Source: keyboards/sporewoh/banime40 in QMK firmware (PR #16694)
 *
 * Layer 0: Base QWERTY
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * │  Z  │  X  │  C  │  V  │  B  │  N  │  M  │  ,  │  .  │ //4 │
   * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
   * │LCTL │LGUI │LALT │LSFT │BSP/2│SPC/1│ ENT │ APP │ DEL │ ESC │
   * └─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
   */
  [0] = LAYOUT_ortho_4x10(
   ...
   * │ TAB │ F11 │ F12 │     │     │     │     │     │     │     │
   * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
   * │ CAP │ PRT │ SCL │ PAU │     │ NUM │     │ VO- │ VO+ │MUTE │
   * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
   * │     │     │     │     │ ███ │     │     │     │     │     │
   * └─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
   */
